...
public partial class AdventureWorksLt2019Context : DbContext
{
    ...
    //        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-LLPQ4RI\\SQLEXPRESS;Initial Catalog=AdventureWorksLT2019;Integrated Security=True;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Address>(entity =>
        {
            ...
            entity.ToTable("Address", "SalesLT", tb =>
                {
                    tb.HasComment("Street address information for customers.");
                    tb.HasTrigger("triggerLogAddress");
                });
            ...
            entity.ToTable("Customer", "SalesLT", tb =>
                {
                    ...
                    tb.HasTrigger("triggerLogCustomer");
                });
        ...
        modelBuilder.Entity<CustomerAddress>(entity =>
        {
            ...
            entity.ToTable("CustomerAddress", "SalesLT", tb =>
                {
                    tb.HasComment("Cross-reference table mapping customers to their address(es).");
                    tb.HasTrigger("UpdateIsPrimary");
                    tb.HasTrigger("triggerLogCustomerAddress");
                });
        ...
        modelBuilder.Entity<CustomerProduct>(entity =>
        {
            ...
            entity.ToTable("CustomerProduct", tb =>
                {
                    tb.HasTrigger("MoveToSalesOrder");
                    tb.HasTrigger("WishlistQuantity");
                });
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__Operatio__5E5499A8E58A18D0");
        ...
        modelBuilder.Entity<ProductCategory>(entity =>
        {
            ...
            entity.ToTable("ProductCategory", "SalesLT", tb =>
                {
                    tb.HasComment("High-level product categorization.");
                    tb.HasTrigger("triggerLogProductCategory");
                });
        ...
        modelBuilder.Entity<ProductDescription>(entity =>
        {
            ...
            entity.ToTable("ProductDescription", "SalesLT", tb =>
                {
                    tb.HasComment("Product descriptions in several languages.");
                    tb.HasTrigger("triggerLogProductDescription");
                });
        ...
        modelBuilder.Entity<ProductModel>(entity =>
        {
            ...
            entity.ToTable("ProductModel", "SalesLT", tb => tb.HasTrigger("triggerLogProductModel"));
        ...
        modelBuilder.Entity<ProductModelProductDescription>(entity =>
        {
            ...
            entity.ToTable("ProductModelProductDescription", "SalesLT", tb =>
                {
                    tb.HasComment("Cross-reference table mapping product descriptions and the language the description is written in.");
                    tb.HasTrigger("triggerLogProductModelProductDescription");
                });
            ...
            entity.ToTable("SalesOrderDetail", "SalesLT", tb =>
                {
                    ...
                    tb.HasTrigger("triggerSalesOrderDetail");
                });
        ...
        modelBuilder.Entity<SalesOrderHeader>(entity =>
        {
            ...
            entity.ToTable("SalesOrderHeader", "SalesLT", tb =>
                {
                    ...
                    tb.HasTrigger("triggerSalesOrderHeader");
            ...
            entity.Property(e => e.AccountNumber)
                .HasMaxLength(11)
                .HasComputedColumnSql("('10-4020-'+right('000000'+CONVERT([nvarchar],[CustomerID]),(3)))", false);
            ...
            entity.Property(e => e.PurchaseOrderNumber)
                .HasMaxLength(12)
                .HasComputedColumnSql("('PO'+right('0000000000'+CONVERT([nvarchar],[CustomerID]),(10)))", false);
